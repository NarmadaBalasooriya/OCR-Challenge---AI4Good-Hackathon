...
tf.app.flags.DEFINE_float('decay_rate', 0.88, 'the lr decay rate')
...
tf.app.flags.DEFINE_float('momentum', 0.8, 'the momentum')
    ...
    def __init__(self, data_dir):
        ...
        for root, sub_folder, file_list in os.walk(data_dir):
            for file_path in file_list:
                ...
                im = cv2.resize(im, (FLAGS.image_height, FLAGS.image_width))
